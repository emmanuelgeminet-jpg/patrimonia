...
export async function saveAnalyse(_prev: SaveState, formData: FormData): Promise<SaveState> {
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      frais_agence_cents: toCentsOrNull(formData.get("frais_agence")),
      frais_dossier_garantie_cents: toCentsOrNull(formData.get("frais_dossier_garantie")),
      ...
      taxe_fonciere_cents: toCentsOrNull(formData.get("taxe_fonciere")),
      charges_copro_cents: toCentsOrNull(formData.get("charges_copro")),
      assurance_pno_cents: toCentsOrNull(formData.get("assurance_pno")),
