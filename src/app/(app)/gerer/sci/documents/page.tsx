...
async function chargerDocuments(supabase: SupabaseClient<any>, sciId: string): Promise<DocItem[]> {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function chargerQuittances(supabase: SupabaseClient<any>, sciId: string): Promise<QuittanceArchiveItem[]> {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function chargerBaux(supabase: SupabaseClient<any>, sciId: string): Promise<BailArchiveItem[]> {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function chargerEtatsDesLieux(supabase: SupabaseClient<any>, sciId: string): Promise<EtatDesLieuxArchiveItem[]> {
...
export default async function DocumentsPage() {
  ...
  const [documents, quittancesItems, bauxItems, edlItems] = await Promise.all([
    chargerDocuments(supabase, sciId),
    chargerQuittances(supabase, sciId),
    chargerBaux(supabase, sciId),
    chargerEtatsDesLieux(supabase, sciId),
  ]);
